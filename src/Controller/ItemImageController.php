...
class ItemImageController extends Controller
{
    ...
    {
        parent::__construct($db_connection, $endpoint, $request_method, new ItemImageModel($db_connection));
    }
                ...
                switch ($this->request_method) {
                    case 'POST':
                        ...
                        if ($token_data) {
                            ...
                            if (
                                !empty($this->model->id_item = trim($_POST['id_item'] ?? null)) &&
                                !empty($this->model->is_main = trim($_POST['is_main'] ?? null)) &&
                                ...
                                if (
                                    ...
                                    if (is_uploaded_file($_FILES['image']['tmp_name'])) {
                                        ...
                                        $this->model->is_main = $this->model->is_main === "True" ? 1 : 0;
